...
<div class="card rounded mb-5 mb-xl-8 shadow-lg">
    ...
    <div class="card-header rounded border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Services</span>
        </h3>
            ...
            <table class="table table-hover align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        <th class="ps-4 min-w-325px rounded-start">service</th>
                    ...
                    <tr class="text-center border-3 m-auto align-middle">
                        <td class="px-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="{{ route('service.edit', $p->id) }}" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$p->title_en}}</a>
                        ...
                        <td class="px-3">
                         ...
                         <td class="border text-center">
                            ...
                            <a href="{{ route('service.edit', $p->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <form action="{{ route('service.destroy', $p->id) }}" method="post" id='delform' style="display: inline-block">
                                @csrf
                                @method('delete')
