            ...
            <form method="post" action="{{ route('service.update', $service->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group mb-10 col-md-6">
                        ...
                        <textarea name="des_en" class="form-control form-control-solid" rows="2" id="editor">{{ $service->des_en }}</textarea>
                    ...
                    <div class="form-group mb-10 col-md-6">
                        ...
                        <textarea name="des_ar" class="form-control form-control-solid" rows="2" id="editor">{{ $service->des_ar }}</textarea>
                    </div>
                </div>
