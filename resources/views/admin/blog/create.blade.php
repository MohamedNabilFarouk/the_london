        ...
        <div class="card rounded card-form__body card-body shadow-lg">
            <form method="post" action="{{ route('blog.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-10">
                    ...
                    <textarea name="summary_en" class="form-control form-control-solid" rows="2" id="editor">{{ old('summary_en') }}</textarea>
                
                </div>
                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">summary Ar</label>
                    <textarea name="summary_ar" class="form-control form-control-solid" rows="2" id="editor">{{ old('summary_ar') }}</textarea>
                
                </div>
                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">description En</label>
                    <textarea name="des_en" class="form-control form-control-solid" rows="2" id="editor">{{ old('des_en') }}</textarea>
