 ...
 <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
     ...
     <div class="aside-logo flex-column-auto" id="kt_aside_logo" style="height: 120px;">
         <!--begin::Logo-->
         <a href="#" class="m-auto">
             <img alt="Logo" src="{{ $site_settings->logo }}" class=" logo" style="height: 50px;width: 100%;" />
             {{-- <img alt="Logo" src="{{asset('site/img/shiiry-logo-white.png')}}" class=" logo" style="height: 100px;width: 100%;" /> --}}
         </a>
         <!--end::Logo-->
         <!--begin::Aside toggler-->
             ...
             <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                 ...
                 <div class="menu-item">
                     <div class="menu-content pt-8 pb-2">
                         <span class="menu-section text-muted text-uppercase fs-8">All Sections</span>
                     </div>
                 </div>
                 ...
                 <!-- chooseUs -->
                 <div class="menu-item">
                    <a class="menu-link" href="{{ route('chooseUs.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/stockholm/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                 ...
                 {{-- technical data --}}
                 <div class="menu-item">
                     <a class="menu-link" href="{{ route('site.technicalData') }}">
                         <span class="menu-icon">
                             <!--begin::Svg Icon | path: icons/stockholm/Design/PenAndRuller.svg-->
                             <span class="svg-icon svg-icon-2">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                         ...
                         <span class="menu-title">Technical Data</span>
                     </a>
                 </div>
                 {{-- end technical data --}}
                 ...
                 <div class="menu-item">
                     <a class="menu-link" href="{{ route('message.index') }}">
                         ...
                         <span class="menu-title">Contact Us Messages</span>
                     </a>
                 </div>
                 {{-- end messages --}}
                 {{-- Subscribers --}}
                 ...
                 <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                     <span class="menu-link">
                         ...
                         <span class="menu-title">Static</span>
                         <span class="menu-arrow"></span>
                     </span>
                     <div class="menu-sub menu-sub-accordion menu-active-bg">
                         <div class="menu-item">
                             <a class="menu-link" href="{{ route('settings.site.show') }}">
                                 ...
                                 <span class="menu-title">Site Date</span>
                             </a>
                         </div>
