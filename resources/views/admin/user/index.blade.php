...
<div class="card rounded mb-5 mb-xl-8 shadow-lg">
    ...
    <div class="card-header rounded border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">{{__('site.Users')}}</span>
        </h3>
        <div class="card-toolbar">
          <form action="{{route('filter')}}" method="get">
              ...
              <div class="row">
                ...
                <input type="number" name='gen' class="form-control" placeholder="filter By generation number" >
                </div>
            <div class='col-md-3'>
            ...
            <table class="table table-hover align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-125px">{{__('Generation')}}</th>
                ...
                @foreach($users as $index => $c)
                    ...
                    <tr class="text-center border-3 m-auto @if($c->generation == '4') bg-light-warning @elseif( $c->generation == '6' ) bg-primary @endif">
                         <td class="px-3">
                         ...
                         <td class="px-3">
                                    <span class="badge badge-light-primary fs-7 fw-bold">{{$c->generation}}</span>
                        </td>
                         <td class="px-3">
                                    <span class="badge badge-light-primary fs-7 fw-bold">{{$c->code}}</span>
                        </td>
