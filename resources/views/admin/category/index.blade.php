...
<div class="card rounded mb-5 mb-xl-8 shadow-lg">
    ...
    <div class="card-header rounded border-0 pt-5">
        ...
        <div class="card-toolbar">
            <a href="{{route('category.create')}}" class="btn btn-sm btn-light-primary">
                    ...
                    <tr class="text-center border-3 m-auto align-middle">
                        ...
                        <td class="px-3">
                         ...
                         <td class="border text-center">
                            ...
                            <a href="{{ route('category.edit', $p->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <form action="{{ route('category.destroy', $p->id) }}" method="post" id='delform' style="display: inline-block">
                                @csrf
                                @method('delete')
